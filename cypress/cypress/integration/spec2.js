...
        // Usa cy.contains para selecionar o botão Comprar e clicar nele
        cy.get('[data-id=3]').within(() => {
           cy.contains('Comprar').click()
        })

        // Espera que o pop-up seja exibido com a confirmação da compra
        cy.wait(2000)

        // Verifica se nesse pop-up temos a mensagem de sucesso
